...
namespace Catalog.API.Data
{
    ...
    {
        public static void SeedData(IMongoCollection<Products> ProductsCollection)
        {
            bool existProducts = ProductsCollection.Find(p => true).Any();
            if (!existProducts)
            {
                ProductsCollection.InsertManyAsync(GetPreconfiguredProductss());
            }
        }
        private static IEnumerable<Products> GetPreconfiguredProductss()
        {
